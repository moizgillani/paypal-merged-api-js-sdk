...
| `shipping` | [`OrderShippingDetails \| undefined`](../../doc/models/order-shipping-details.md) | Optional | The shipping address and method. |
...
| `payments` | [`PaymentCollection \| undefined`](../../doc/models/payment-collection.md) | Optional | The comprehensive history of payments for the purchase unit. |
