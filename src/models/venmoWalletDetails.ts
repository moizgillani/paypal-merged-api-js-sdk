...
export interface VenmoWalletDetails {
...
export const venmoWalletDetailsSchema: Schema<VenmoWalletDetails> = object({
  description: ['description', optional(string())],
  usagePattern: ['usage_pattern', optional(billingAgreementPatternEnumSchema)],
  usageType: ['usage_type', optional(venmoUsageTypeEnumSchema)],
