...
/**
 * Enum for PayeeFXRateIdCurrencyMismatchDescriptionEnum
 */
export enum PayeeFXRateIdCurrencyMismatchDescriptionEnum {
...
/**
 * Schema for PayeeFXRateIdCurrencyMismatchDescriptionEnum
 */
export const payeeFXRateIdCurrencyMismatchDescriptionEnumSchema: Schema<PayeeFXRateIdCurrencyMismatchDescriptionEnum> = stringEnum(PayeeFXRateIdCurrencyMismatchDescriptionEnum);
