...
export interface NetworkTransactionReferencePayments {
  ...
  network?: CardBrandEnum;
  /** Reference ID issued for the card transaction. This ID can be used to track the transaction across processors, card brands and issuing banks. */
  acquirerReferenceNumber?: string;
}

export const networkTransactionReferencePaymentsSchema: Schema<NetworkTransactionReferencePayments> = object(
  {
    id: ['id', string()],
    date: ['date', optional(string())],
    network: ['network', optional(cardBrandEnumSchema)],
