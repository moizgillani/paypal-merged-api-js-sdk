...
export interface PayPalWalletResponsePaymentMethodTokens {
...
export const payPalWalletResponsePaymentMethodTokensSchema: Schema<PayPalWalletResponsePaymentMethodTokens> = object(
  {
