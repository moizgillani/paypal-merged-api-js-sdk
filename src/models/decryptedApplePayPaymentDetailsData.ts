...
export interface DecryptedApplePayPaymentDetailsData {
...
export const decryptedApplePayPaymentDetailsDataSchema: Schema<DecryptedApplePayPaymentDetailsData> = object(
  {
