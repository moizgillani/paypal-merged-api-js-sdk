...
import {
  ...
  orderShippingDetailsSchema,
} from './orderShippingDetails';
import { PaymentCollection, paymentCollectionSchema } from './paymentCollection';
import {
  PaymentInstruction,
...
export const purchaseUnitSchema: Schema<PurchaseUnit> = object({
  ...
  shipping: ['shipping', optional(lazy(() => orderShippingDetailsSchema))],
  supplementaryData: [
    'supplementary_data',
