...
/**
 * Enum for MerchInitAuthResultsDescEnum
 */
export enum MerchInitAuthResultsDescEnum {
...
/**
 * Schema for MerchInitAuthResultsDescEnum
 */
export const merchInitAuthResultsDescEnumSchema: Schema<MerchInitAuthResultsDescEnum> = stringEnum(MerchInitAuthResultsDescEnum);
