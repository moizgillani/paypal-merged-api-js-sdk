...
/**
 * Enum for MerchantInitiatedWithSecurityCodeDescriptionEnum
 */
export enum MerchantInitiatedWithSecurityCodeDescriptionEnum {
...
/**
 * Schema for MerchantInitiatedWithSecurityCodeDescriptionEnum
 */
export const merchantInitiatedWithSecurityCodeDescriptionEnumSchema: Schema<MerchantInitiatedWithSecurityCodeDescriptionEnum> = stringEnum(MerchantInitiatedWithSecurityCodeDescriptionEnum);
