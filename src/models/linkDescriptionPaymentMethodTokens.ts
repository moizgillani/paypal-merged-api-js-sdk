...
export interface LinkDescriptionPaymentMethodTokens {
...
export const linkDescriptionPaymentMethodTokensSchema: Schema<LinkDescriptionPaymentMethodTokens> = object(
  {
    href: ['href', string()],
    rel: ['rel', string()],
    method: ['method', optional(httpMethodEnumSchema)],
  }
);
