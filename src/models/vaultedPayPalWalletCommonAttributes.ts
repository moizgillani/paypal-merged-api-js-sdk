...
export interface VaultedPayPalWalletCommonAttributes {
...
export const vaultedPayPalWalletCommonAttributesSchema: Schema<VaultedPayPalWalletCommonAttributes> = object(
  {
    ...
    usageType: ['usage_type', usageTypeEnumSchema],
