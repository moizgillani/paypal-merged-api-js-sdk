...
export interface Badrequest400errorresponseissuesItems {
  issue?: InvalidParameterValueIssueEnum;
  description?: InvalidParameterValueDescriptionPaymentsEnum;
}

export const badrequest400errorresponseissuesItemsSchema: Schema<Badrequest400errorresponseissuesItems> = object(
  {
