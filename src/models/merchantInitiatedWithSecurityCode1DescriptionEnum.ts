...
/**
 * Enum for MerchantInitiatedWithSecurityCode1DescriptionEnum
 */
export enum MerchantInitiatedWithSecurityCode1DescriptionEnum {
...
/**
 * Schema for MerchantInitiatedWithSecurityCode1DescriptionEnum
 */
export const merchantInitiatedWithSecurityCode1DescriptionEnumSchema: Schema<MerchantInitiatedWithSecurityCode1DescriptionEnum> = stringEnum(MerchantInitiatedWithSecurityCode1DescriptionEnum);
