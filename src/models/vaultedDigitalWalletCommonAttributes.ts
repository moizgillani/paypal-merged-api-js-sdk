...
export interface VaultedDigitalWalletCommonAttributes {
...
export const vaultedDigitalWalletCommonAttributesSchema: Schema<VaultedDigitalWalletCommonAttributes> = object(
  {
