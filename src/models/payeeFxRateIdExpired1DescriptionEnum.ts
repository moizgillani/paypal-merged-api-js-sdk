...
/**
 * Enum for PayeeFxRateIdExpired1DescriptionEnum
 */
export enum PayeeFxRateIdExpired1DescriptionEnum {
...
/**
 * Schema for PayeeFxRateIdExpired1DescriptionEnum
 */
export const payeeFxRateIdExpired1DescriptionEnumSchema: Schema<PayeeFxRateIdExpired1DescriptionEnum> = stringEnum(PayeeFxRateIdExpired1DescriptionEnum);
