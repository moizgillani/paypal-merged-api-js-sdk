...
/**
 * Enum for PayeeFxRateIdExpired3DescriptionEnum
 */
export enum PayeeFxRateIdExpired3DescriptionEnum {
...
/**
 * Schema for PayeeFxRateIdExpired3DescriptionEnum
 */
export const payeeFxRateIdExpired3DescriptionEnumSchema: Schema<PayeeFxRateIdExpired3DescriptionEnum> = stringEnum(PayeeFxRateIdExpired3DescriptionEnum);
