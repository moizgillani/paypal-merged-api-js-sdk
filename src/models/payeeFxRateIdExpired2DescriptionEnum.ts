...
/**
 * Enum for PayeeFxRateIdExpired2DescriptionEnum
 */
export enum PayeeFxRateIdExpired2DescriptionEnum {
...
/**
 * Schema for PayeeFxRateIdExpired2DescriptionEnum
 */
export const payeeFxRateIdExpired2DescriptionEnumSchema: Schema<PayeeFxRateIdExpired2DescriptionEnum> = stringEnum(PayeeFxRateIdExpired2DescriptionEnum);
