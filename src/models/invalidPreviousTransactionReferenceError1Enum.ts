...
/**
 * Enum for InvalidPreviousTransactionReferenceError1Enum
 */
export enum InvalidPreviousTransactionReferenceError1Enum {
...
/**
 * Schema for InvalidPreviousTransactionReferenceError1Enum
 */
export const invalidPreviousTransactionReferenceError1EnumSchema: Schema<InvalidPreviousTransactionReferenceError1Enum> = stringEnum(InvalidPreviousTransactionReferenceError1Enum);
