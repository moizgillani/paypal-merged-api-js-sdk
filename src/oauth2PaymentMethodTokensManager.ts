...
import { OAuthScopeOauth2PaymentMethodTokensEnum } from './models/oAuthScopeOauth2PaymentMethodTokensEnum';

export class Oauth2PaymentMethodTokensManager {
  private _oAuthClientId: string;
  private _oAuthClientSecret: string;
  private _oAuthScopes?: OAuthScopeOauth2PaymentMethodTokensEnum[];
  ...
  public async fetchToken(
    ...
    const { result } = await this._oAuthController.requestTokenOauth2PaymentMethodTokens(
      authorization,
