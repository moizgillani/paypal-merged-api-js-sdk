...
/**
 * Creates an instance of AuthorizationsCaptureResponse403Json
 */
interface AuthorizationsCaptureResponse403Json {
...
export class AuthorizationsCaptureResponse403JsonError extends ApiError<AuthorizationsCaptureResponse403Json> {}
