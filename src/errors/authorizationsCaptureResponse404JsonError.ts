...
/**
 * Creates an instance of AuthorizationsCaptureResponse404Json
 */
interface AuthorizationsCaptureResponse404Json {
...
export class AuthorizationsCaptureResponse404JsonError extends ApiError<AuthorizationsCaptureResponse404Json> {}
