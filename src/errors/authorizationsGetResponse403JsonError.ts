...
/**
 * Creates an instance of AuthorizationsGetResponse403Json
 */
interface AuthorizationsGetResponse403Json {
...
export class AuthorizationsGetResponse403JsonError extends ApiError<AuthorizationsGetResponse403Json> {}
