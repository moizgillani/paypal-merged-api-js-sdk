...
/**
 * Creates an instance of RefundsGetResponse404Json
 */
interface RefundsGetResponse404Json {
...
export class RefundsGetResponse404JsonError extends ApiError<RefundsGetResponse404Json> {}
