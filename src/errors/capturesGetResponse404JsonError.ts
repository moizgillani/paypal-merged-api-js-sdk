...
/**
 * Creates an instance of CapturesGetResponse404Json
 */
interface CapturesGetResponse404Json {
...
export class CapturesGetResponse404JsonError extends ApiError<CapturesGetResponse404Json> {}
