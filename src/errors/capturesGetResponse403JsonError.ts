...
/**
 * Creates an instance of CapturesGetResponse403Json
 */
interface CapturesGetResponse403Json {
...
export class CapturesGetResponse403JsonError extends ApiError<CapturesGetResponse403Json> {}
