...
/**
 * Creates an instance of AuthorizationsGetResponse404Json
 */
interface AuthorizationsGetResponse404Json {
...
export class AuthorizationsGetResponse404JsonError extends ApiError<AuthorizationsGetResponse404Json> {}
